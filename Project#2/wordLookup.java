/*This program is intended to show that when typed a new term on the screen and the 
 *system can check whether this term is one letter different from the previous one.
 *Class: CS 107, Spring 2012
 *TA: Venkatakumar Srinivasan, 939 SEO, Tue & Thur 2:00 PM - 3:00 PM
 *Program #2: Word Morph Game 
 *Programmed by: Jian Heng Feng
 */
...
public class wordLookup
{
    ...
    void mainLoop() throws IOException 
    {
        ...
        boolean gamePlay = true;// String
        while(gamePlay == true)// looping up
        {
        	 // The code below is just a sample of how to look up a word
        	System.out.print("Enter a word to lookup: ");
            userInput = keyboard.next();//with this, keyboard is available
            userInput = userInput.toLowerCase();// convert to all upper case
